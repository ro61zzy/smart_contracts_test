...
const provider = new ethers.providers.AlchemyProvider("mainnet", process.env.ALCHEMY_PROJECT_ID);
...
async function removeLiquidity() {
    const liquidity = ethers.utils.parseUnits("1.0", 18);  
    const amountAMin = ethers.utils.parseUnits("500", 6);  
    const amountBMin = ethers.utils.parseUnits("500", 18); 
